...
This two full-day workshop provides the basics of time series analysis and forecasting in R. This workshop is part of the [F4SG](https://www.f4sg.org/) initiative and is supported by the [IIF](https://forecasters.org/). The workshop will run in-person at [UM6P](https://www.um6p.ma/) in Rabat, Morocco in June 2024.
